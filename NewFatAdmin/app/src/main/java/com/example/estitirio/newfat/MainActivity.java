...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), insertMakanan.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_makanan) {
            Intent i = new Intent(this.getApplicationContext(), makanan.class);
            startActivity(i);
        }
        else if (id == R.id.nav_kategori) {
            Intent i = new Intent(this.getApplicationContext(), kategori.class);
            startActivity(i);
        }

        else if (id == R.id.nav_wilayah) {
            Intent i = new Intent(this.getApplicationContext(), wilayah.class);
            startActivity(i);
        }
